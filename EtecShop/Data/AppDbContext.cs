...
public class AppDbContext : IdentityDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        List<Produto> produtos = new()
        {
            ...
            new Produto(){
                Id = 5,
                Nome = "Notebook 2 Em 1 Positivo Duo C4128b-3",Descricao = "Notebook 2 Em 1 Positivo Duo C4128b-3 Intel Celeron Dual Core Windows11 Home 11,6' - Cinza Escuro - Inclui Microsoft 365* Notebook 2 em 1 Positivo Duo C4128B-3 Intel Celeron Dual Core Windows11 Home 11,6' - Cinza Escuro",
                Preco = 1439.10M,
                Estoque = 17,
                CategoriaId = 3,
